# FreePerryLarp1 operating contract

## Product architecture

The paid side is fixed:

- product ID: `auralo-pheromone-perfume-15ml`
- public name: `Auralo Pheromone Perfume`
- price: `$29`
- facts: only the versioned entries in `auralo-dossier.json`

The FREE side is campaign-local. Its identity, claims, reference assets, offer
...
dependent. Auralo must carry independent paid-product desire; the FREE product
